...
namespace luly::renderer
{
    ...
    private:
        static std::shared_ptr<model> load_model_using_assimp(const std::string& file_path);
        static void parse_assimp_node(const aiScene* assimp_scene, aiNode* assimp_node,
