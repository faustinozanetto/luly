...
{
    std::shared_ptr<texture> texture_factory::create_texture_from_file(const std::string& file_path)
    {
        ...
        auto created_texture = std::make_shared<texture>(texture_specification);
