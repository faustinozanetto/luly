...
#define SHADOWS_UBO_LOCATION 2
#define DIRECTIONAL_LIGHT_SHADOWS_UBO_LOCATION 3
#define DIRECTIONAL_LIGHT_LIGHT_MATRICES_UBO_LOCATION 4
#define DIRECTIONAL_LIGHT_FRUSTUM_PLANES_UBO_LOCATION 5
#define POINT_LIGHT_SHADOWS_UBO_LOCATION 6
