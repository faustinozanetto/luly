...
{
    physics_spherical_joint::physics_spherical_joint(const std::shared_ptr<physics_actor>& physics_actor_a,
    ...
    {
        physics_spherical_joint::release_joint();
    }
    ...
    void physics_spherical_joint::set_spherical_joint_flags(physx::PxSphericalJointFlags flags) const
    {
        m_physx_spherical_joint->setSphericalJointFlags(flags);
    }

    void physics_spherical_joint::set_spherical_joint_flag(physx::PxSphericalJointFlag::Enum flag, bool value) const
    {
    ...
    void physics_spherical_joint::set_projection_linear_tolerance(float tolerance) const
    {
