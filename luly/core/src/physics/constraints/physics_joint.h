...
namespace luly::physics
{
    ...
    {
    public:
        physics_joint(const std::shared_ptr<physics_actor>& physics_actor_a,
                      const std::shared_ptr<physics_actor>& physics_actor_b) : m_physics_actor_a(physics_actor_a),
                                                                               m_physics_actor_b(physics_actor_b)
        {
        }
